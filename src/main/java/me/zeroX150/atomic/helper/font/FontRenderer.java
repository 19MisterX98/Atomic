...
public class FontRenderer {
    ...
    public void setResourceLocation(String base64, float size) {
        ...
        this.resourceLocation = new Identifier("atomic", "font" + getFont().getFontName().toLowerCase().replace(" ", "-") + size);
    ...
    public void drawCenteredString(MatrixStack ms, String text, double x, double y, int color) {
        drawCenteredString(ms, text, (float) x, (float) y, color);
    }
